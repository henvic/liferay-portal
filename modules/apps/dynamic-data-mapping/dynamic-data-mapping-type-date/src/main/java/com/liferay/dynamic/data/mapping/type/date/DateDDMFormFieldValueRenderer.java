...
public class DateDDMFormFieldValueRenderer
	...
	public String render(DDMFormFieldValue ddmFormFieldValue, Locale locale) {
		Boolean valueBoolean = _dateDDMFormFieldValueAccessor.getValue(
	...
	@Reference
	protected void setDateDDMFormFieldValueAccessor(
		DateDDMFormFieldValueAccessor dateDDMFormFieldValueAccessor) {

		_dateDDMFormFieldValueAccessor = dateDDMFormFieldValueAccessor;
	}

	private DateDDMFormFieldValueAccessor
		_dateDDMFormFieldValueAccessor;
