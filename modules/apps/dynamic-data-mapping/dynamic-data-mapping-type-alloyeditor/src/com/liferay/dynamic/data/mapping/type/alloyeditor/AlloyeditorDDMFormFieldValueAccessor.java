 ...
 */
@Component(
	immediate = true, property = "ddm.form.field.type.name=alloyEditor",
	service = {
		DDMFormFieldValueAccessor.class, AlloyEditorDDMFormFieldValueAccessor.class
	}
)
public class AlloyEditorDDMFormFieldValueAccessor
	...
	private static final Log _log = LogFactoryUtil.getLog(
		AlloyEditorDDMFormFieldValueAccessor.class);
